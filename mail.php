<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ( empty($name) OR empty($num) OR empty($sub) OR empty($comment) OR !filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        // Send the email.
        if (mail($recipient, $num, $sub, $email_content, $email_headers)) {
